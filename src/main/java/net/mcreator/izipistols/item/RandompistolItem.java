...
public class RandompistolItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:randompistol")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybulletrandompistol")
	public static final EntityType arrow = null;
	public RandompistolItem(IziPistolsModElements instance) {
		super(instance, 30);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletrandompistol").setRegistryName("entitybulletrandompistol"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(3));
			setRegistryName("randompistol");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 5f, 0.1, 0);
			...
			if (this.inGround) {
				{
					...
					RandompistolBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
