...
public class EmeraudpistolItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:emeraudpistol")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybulletemeraudpistol")
	public static final EntityType arrow = null;
	public EmeraudpistolItem(IziPistolsModElements instance) {
		super(instance, 15);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletemeraudpistol").setRegistryName("entitybulletemeraudpistol"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(450));
			setRegistryName("emeraudpistol");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 5f, 3, 1);
