...
public class TNTPistolItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:tnt_pistol")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybullettnt_pistol")
	public static final EntityType arrow = null;
	public TNTPistolItem(IziPistolsModElements instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybullettnt_pistol").setRegistryName("entitybullettnt_pistol"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 1.25, 0);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				TNTPistolBulletHitsBlockProcedure.executeProcedure($_dependencies);
			}
		}
