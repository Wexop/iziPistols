...
public class DiamspistolItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:diamspistol")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybulletdiamspistol")
	public static final EntityType arrow = null;
	public DiamspistolItem(IziPistolsModElements instance) {
		super(instance, 13);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletdiamspistol").setRegistryName("entitybulletdiamspistol"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 2.25, 1);
