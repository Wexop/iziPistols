...
public class GoldpistolItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:goldpistol")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybulletgoldpistol")
	public static final EntityType arrow = null;
	public GoldpistolItem(IziPistolsModElements instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletgoldpistol").setRegistryName("entitybulletgoldpistol"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(75));
			setRegistryName("goldpistol");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 0.8, 1);
