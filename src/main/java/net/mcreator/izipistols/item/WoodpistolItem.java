...
public class WoodpistolItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:woodpistol")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybulletwoodpistol")
	public static final EntityType arrow = null;
	public WoodpistolItem(IziPistolsModElements instance) {
		super(instance, 7);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletwoodpistol").setRegistryName("entitybulletwoodpistol"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 0.2, 0);
