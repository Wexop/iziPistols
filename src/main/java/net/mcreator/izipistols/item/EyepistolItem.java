...
public class EyepistolItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:eyepistol")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybulleteyepistol")
	public static final EntityType arrow = null;
	public EyepistolItem(IziPistolsModElements instance) {
		super(instance, 20);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulleteyepistol").setRegistryName("entitybulleteyepistol"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(30));
			setRegistryName("eyepistol");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 0.3, 0);
			...
			if (this.inGround) {
				{
					...
					EyepistolBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
