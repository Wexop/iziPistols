...
public class StonepistoItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:stonepisto")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybulletstonepisto")
	public static final EntityType arrow = null;
	public StonepistoItem(IziPistolsModElements instance) {
		super(instance, 5);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletstonepisto").setRegistryName("entitybulletstonepisto"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 0.25, 0);
