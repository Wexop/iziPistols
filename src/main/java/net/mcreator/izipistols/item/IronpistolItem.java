...
public class IronpistolItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:ironpistol")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybulletironpistol")
	public static final EntityType arrow = null;
	public IronpistolItem(IziPistolsModElements instance) {
		super(instance, 9);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletironpistol").setRegistryName("entitybulletironpistol"));
	}
