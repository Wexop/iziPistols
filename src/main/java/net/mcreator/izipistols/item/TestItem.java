...
public class TestItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:test")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybullettest")
	public static final EntityType arrow = null;
	public TestItem(IziPistolsModElements instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybullettest").setRegistryName("entitybullettest"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 0.1, 0);
