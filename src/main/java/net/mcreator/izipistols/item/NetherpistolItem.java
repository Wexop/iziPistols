...
public class NetherpistolItem extends IziPistolsModElements.ModElement {
	@ObjectHolder("izi_pistols:netherpistol")
	public static final Item block = null;
	@ObjectHolder("izi_pistols:entitybulletnetherpistol")
	public static final EntityType arrow = null;
	public NetherpistolItem(IziPistolsModElements instance) {
		super(instance, 22);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletnetherpistol").setRegistryName("entitybulletnetherpistol"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 5f, 0.3, 0);
